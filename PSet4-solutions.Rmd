...
Similar to visualization of missing column values, plot 1 shows the missing values that appear in th rows (in the order they appear). And plot 2 shows missing values by rows in a sorted manner. Multiple rows have the highest number of missing values including row numbers 8,6,5,30,3,29,22,2,18,14,1.
...
Graphs in (a)  and (b) show that value/price of silver has been below 100 throughout the years.
