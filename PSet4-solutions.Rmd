...
<svg width="500" height="400" viewBox="0 0 125 100" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="scale(0.85) translate(23,10)">
    ...
    <g stroke="#f9f9f9" stroke-width="0.5" transform=""> 
      ...
      <g> 
        <rect x="`r t[['M','all']]`" y="0" height="`r t[['F', 'Republican']]`" width="`r t[['F','all']]`" fill="red"></rect> 
        <rect x="`r t[['M','all']]`" y="`r t[['F', 'Republican']]`" height="`r t[['F', 'Democrat']]`" width="`r t[['F','all']]`" fill="#00AEF3"></rect> 
      </g> 
    </g> 
