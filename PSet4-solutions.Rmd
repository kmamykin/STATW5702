...
ggplot(df, aes(map_id = State)) + 
  ...
  scale_fill_gradient2(low = "green", mid = "white", high = "red", na.value = "white", name = "Deaths per 100,000") +
  coord_fixed(1.3) +
...
The visualization shows the progression of the opioid crisis in the United States, and the states most affected. While in 2002 and 2005 there was relatively little change, starting with 2008 West Virginia starts to climb in the drug related deaths, and by 2017 West Virginia is the leading state in this crisis with 56.3 deaths per 100,000. The states nearing West Virginia are also highly affected, Ohio (45.4 per 100,000), Pensilvania (42.9 per 100,000) and Kentucky (37.3 per 100,000).
...
```{r}
# TODO One axis should be labeled "Gender" and the other "Political Party"
