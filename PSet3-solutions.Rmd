...
```{r}
selected_schools_DBNs <- paste("03M", str_pad(c(199, 191, 452), 3, pad = "0"), sep = "")
q2019 <- get_school_survey_responses(
  path = "PSet3-data/2019-public-data-file_parent.xlsx", 
  sheet = " Parent %", 
  question = "2f. At this school my child is safe.", 
  ...
  filter(DBN %in% selected_schools_DBNs) %>%
...
likert_data <- bind_rows(q2019, q2014)
```

```{r}
HH::likert(
  data = filter(likert_data, School == 'P.S. 199'), 
  x = Year ~ ., 
  positive.order = FALSE, 
  data.order = TRUE,
  main = "P.S. 199: At this school my child is safe", 
  xlab = "percent", ylab = ""
)
```
```{r}
HH::likert(
  data = filter(likert_data, School == 'P.S. 191'), 
  x = Year ~ ., 
  positive.order = FALSE, 
  data.order = TRUE,
  main = "P.S. 191: At this school my child is safe", 
  xlab = "percent", ylab = ""
)
...
```{r}
HH::likert(
  data = filter(likert_data, School == 'P.S. 452'), 
  x = Year ~ ., 
  positive.order = FALSE, 
  data.order = TRUE,
  main = "P.S. 452: At this school my child is safe", 
  xlab = "percent", ylab = ""
)
