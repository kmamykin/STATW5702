...
weather %>%
  ...
  xlab("humidity") +
  ylab("wind direction") +
  ggtitle("Scatterplot + density of wind direction vs humididy of weather")
```
...
weather %>%
  ggplot(aes(humid, wind_dir)) +
  scale_y_continuous(breaks = seq(0, 360, 30)) +
  geom_hex(binwidth = c(5, 30)) +
  scale_fill_viridis_c() +
  xlab("humidity") +
  ylab("wind direction") +
  ggtitle("Hexagonal heatmap of wind vs humididy of weather")
```
...
weather %>%
  ggplot(aes(humid, wind_dir)) +
  scale_y_continuous(breaks = seq(0, 360, 30)) +
  geom_bin2d(binwidth = c(5, 30)) +
  scale_fill_viridis_c() +
  xlab("humidity") +
  ylab("wind direction") +
  ggtitle("Square heatmap of wind vs humididy of weather")
```
